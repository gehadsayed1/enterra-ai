<template>
  ...
  >
    <div class="mt-6 px-2 flex flex-col gap-2">
      ...
      >
          <span v-if="isOpen" class="text-primary text-2xl font-bold"> ENTERRA AI</span>
        <svg
          width="25"
          height="25"
          viewBox="0 0 20 20"
      ...
      <div
        class="menu-item flex items-center gap-3 p-3 hover:bg-gray-100 cursor-pointer"
      >
      ...
      >
        ...
        <span v-if="isOpen" class="text-gray-700 font-medium">Users</span>
      </div>
    </div>
  </div>
</template>
